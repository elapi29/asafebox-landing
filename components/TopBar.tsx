...
export default function TopBar({ locale }: { locale: string }) {
  // Slash final: importante con trailingSlash:true (Pages sirve index.html por carpeta)
  const home = `/${locale}/`;

  return (
    <header className="fixed inset-x-0 top-0 z-50">
      <div className="glass mx-auto flex max-w-6xl items-center justify-between rounded-b-2xl px-4 py-3">
        {/* LOGO: NO basePath manual, src desde /public; next/image lo prefija solo */}
        ...
        <nav className="flex items-center gap-6 text-sm font-medium text-slate-700">
          ...
          {/* Language Switcher en el TopBar */}
